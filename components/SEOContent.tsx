  ...
  if (city && brand && appliance) {
      ...
      <div className="text-center">
        ...
        <div className="text-gray-700 space-y-4">
          <p className="text-base md:text-lg leading-relaxed">
            ...
            repair for all major brands throughout {city} and the surrounding Denver Metro area. Our certified technicians can diagnose and repair your {appliance.toLowerCase()} quickly and efficiently.
          </p>
    ...
    return (
      <div className="text-center">
        ...
        <div className="text-gray-700 space-y-4">
          <p className="text-base md:text-lg leading-relaxed">
            <strong>H-Prime Appliance Repair Services</strong> is Denver Metro area's trusted source for {brand} appliance repair. With experienced technicians, we specialize in servicing all {brand} appliance models. From routine maintenance to 
